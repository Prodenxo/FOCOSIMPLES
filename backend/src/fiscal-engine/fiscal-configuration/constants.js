...
export const FISCAL_ENGINE_CAPABILITY = Object.freeze({
  ...
  PIS_RESOLUTION: 'PIS_RESOLUTION',
  PIS_XML_BUILDER: 'PIS_XML_BUILDER',
  COFINS_RESOLUTION: 'COFINS_RESOLUTION',
  COFINS_XML_BUILDER: 'COFINS_XML_BUILDER',
  XML_FIELDS_BUILDER: 'XML_FIELDS_BUILDER',
  CROSS_VALIDATOR: 'CROSS_VALIDATOR',
});

export const FISCAL_ENGINE_CAPABILITY_VERSION = '8e4-pis-cofins-1';
