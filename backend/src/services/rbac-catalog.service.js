...
const PERMISSIONS_BY_ROLE = {
  ...
  admin: [
    ...
    { key: 'fiscal.configuration.view', scope: 'app', description: 'Visualizar configuração fiscal do tenant.' },
    { key: 'fiscal.configuration.edit_draft', scope: 'app', description: 'Editar rascunhos de parametrização fiscal.' },
    { key: 'fiscal.configuration.approve', scope: 'app', description: 'Aprovar regras fiscais parametrizadas pelo contador.' },
    { key: 'fiscal.configuration.suspend', scope: 'app', description: 'Suspender regras fiscais aprovadas.' },
    { key: 'fiscal.configuration.revoke', scope: 'app', description: 'Revogar regras fiscais aprovadas.' },
